...
const TECH_GAPS = [
  {
    icon: "🔗",
    title: "מידע מכפיל כח",
    desc: "תיק המפעל הנמצא במערכת השלהבת מכיל מידע קריטי על מחזיק החומ\"ס, החומרים המעורבים, תרחישי הסיכון והיערכות המפעל. בעת אירוע חומ\"ס, על איש הגנה מאש להזרים מידע חיוני מתיק זה למפקד האירוע.",
    color: "#2E86C1"
  },
  {
    icon: "📱",
